          ...
          <div className="space-y-4">
            {socialLinks.map((link) => (
              <div
                key={link.id}
                className={cn(
                  "p-4 border rounded-lg transition-all duration-200 ease-out",
              ...
              {customLinks.map((link) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    {/* Drag Handle */}
                    <button className="mt-2 text-muted-foreground hover:text-foreground cursor-grab active:cursor-grabbing transition-colors">
